...
void ILI9225_InvertDisplay(bool invert) { (void)invert; }
...
{
    if (x >= ILI9225_WIDTH || y >= ILI9225_HEIGHT) return;
    if (x + w > ILI9225_WIDTH || y + h > ILI9225_HEIGHT) return;
    ILI9225_SetWindow(x, y, x + w - 1, y + h - 1);
...
void ILI9225_Test(void)
{
    ...
    // Text test
    ILI9225_FillScreen(ILI9225_BLACK);
    ILI9225_WriteString(10, 10, "ILI9225 Test", Font_16x26, ILI9225_WHITE, ILI9225_BLACK);
    ILI9225_WriteString(10, 40, "176x220 Display", Font_11x18, ILI9225_CYAN, ILI9225_BLACK);
    ILI9225_WriteString(10, 70, "2.0 inch TFT", Font_7x10, ILI9225_YELLOW, ILI9225_BLACK);
    HAL_Delay(2000);
    #endif
